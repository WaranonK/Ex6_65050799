...
public class DeleteEmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("search".equals(action)) {
            ...
            if (emp != null) {
                ...
                request.getRequestDispatcher("DeleteEmployeeConfirm.jsp").forward(request, response);
            } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("message", "1 row is deleted");
            ...
            request.setAttribute("error", "Sorry this record is being updated by another user");
            request.getRequestDispatcher("error.jsp").forward(request, response);
        }
    }
}
